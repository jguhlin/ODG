...
var G__32919 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__32919;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__32920 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__32920,ch);
...
if(("\\" === ch__$1)){
var ch_32921__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_32921__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_32921__$2);
} else {
}

var G__32922 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__32922;
continue;
}
}
...
var G__32933 = cljs.core.conj_BANG_.call(null,a,form);
a = G__32933;
continue;
}
}
...
var _STAR_read_delim_STAR_32934 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_32934;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__32935 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__32935,(0),null);
var start_column = cljs.core.nth.call(null,vec__32935,(1),null);
...
var vec__32941 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__32941,(0),null);
var start_column = cljs.core.nth.call(null,vec__32941,(1),null);
...
var vec__32944 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__32944,(0),null);
var end_column = cljs.core.nth.call(null,vec__32944,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__32947,(0),null);
var start_column = cljs.core.nth.call(null,vec__32947,(1),null);
...
var sb = (function (){var G__32953 = (new goog.string.StringBuffer());
G__32953.append(initch);
...
var G__32955 = (function (){var G__32954 = sb;
G__32954.append(ch);

return G__32954;
})();
var G__32956 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__32955;
ch = G__32956;
continue;
}
...
switch (G__32959) {
case "\\":
var G__32963 = (function (){var G__32960 = sb;
G__32960.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__32960;
})();
var G__32964 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__32963;
ch = G__32964;
continue;
...
break;
default:
var G__32965 = (function (){var G__32961 = sb;
G__32961.append(ch);

return G__32961;
})();
var G__32966 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__32965;
ch = G__32966;
continue;
...
var vec__32967 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__32967,(0),null);
var end_column = cljs.core.nth.call(null,vec__32967,(1),null);
...
var vec__32970 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__32970,(0),null);
var column = cljs.core.nth.call(null,vec__32970,(1),null);
...
var vec__32975 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__32975,(0),null);
var column = cljs.core.nth.call(null,vec__32975,(1),null);
...
var vec__32980 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__32980,(0),null);
var column = cljs.core.nth.call(null,vec__32980,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__32985 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__32985,(0),null);
var start_column = cljs.core.nth.call(null,vec__32985,(1),null);
...
var vec__32988 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__32988,(0),null);
var end_column = cljs.core.nth.call(null,vec__32988,(1),null);
...
var G__32991 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__32991,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_32992 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_32992;
}});
...
var G__32993 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__32993,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__32993,rdr,first_line);
...
var G__32997 = matched;
var G__32998 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__32997;
finished = G__32998;
continue;
} else {
...
var _STAR_suppress_read_STAR_32999 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_32999;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env33000 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__33001 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__33001,"(");
...
var G__33002 = (i + (1));
var G__33003 = cljs.core.conj_BANG_.call(null,args,(function (){var or__28433__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env33000;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__33004 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__33004);
...
var G__33005 = cljs.core.next.call(null,s__$1);
var G__33006 = ret;
s__$1 = G__33005;
r = G__33006;
continue;
...
var G__33007 = cljs.core.next.call(null,s);
var G__33008 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__33007;
key_vals = G__33008;
continue;
} else {
...
var gensym_env33012 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env33012;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__33013 = token;
var G__33013__$1 = (((G__33013 == null))?null:cljs.core.subs.call(null,G__33013,(1)));
var G__33013__$2 = (((G__33013__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__33013__$1));
var G__33013__$3 = (((G__33013__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__33013__$2));
var G__33013__$4 = (((G__33013__$3 == null))?null:cljs.core.symbol.call(null,G__33013__$3));
if((G__33013__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__33013__$4);
}
})():(function (){var G__33014 = token;
var G__33014__$1 = (((G__33014 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__33014));
if((G__33014__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__33014__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__33025,reader){
var map__33026 = p__33025;
var map__33026__$1 = ((((!((map__33026 == null)))?((((map__33026.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33026.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__33026):map__33026);
var opts = map__33026__$1;
var eof = cljs.core.get.call(null,map__33026__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1503577465745
