...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__31457 = cljs.core.instance_QMARK_;
var expr__31458 = reactive_val;
if(cljs.core.truth_(pred__31457.call(null,reagent.ratom.RAtom,expr__31458))){
return "ra";
} else {
if(cljs.core.truth_(pred__31457.call(null,reagent.ratom.RCursor,expr__31458))){
return "rc";
} else {
if(cljs.core.truth_(pred__31457.call(null,reagent.ratom.Reaction,expr__31458))){
return "rx";
} else {
if(cljs.core.truth_(pred__31457.call(null,reagent.ratom.Track,expr__31458))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1503577463040
