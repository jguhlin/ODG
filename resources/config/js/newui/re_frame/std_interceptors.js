...
var vec__33483_33486 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_33487 = cljs.core.nth.call(null,vec__33483_33486,(0),null);
var only_after_33488 = cljs.core.nth.call(null,vec__33483_33486,(1),null);
var db_changed_QMARK__33489 = (!((only_before_33487 == null))) || (!((only_after_33488 == null)));
if(db_changed_QMARK__33489){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_33487);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_33488);
...
var map__33490 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__33490__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__33490__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__33492 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__33492__$1;
var event = cljs.core.get.call(null,map__33492__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__29602__auto___33495 = arguments.length;
var i__29603__auto___33496 = (0);
while(true){
if((i__29603__auto___33496 < len__29602__auto___33495)){
args__29609__auto__.push((arguments[i__29603__auto___33496]));

var G__33497 = (i__29603__auto___33496 + (1));
i__29603__auto___33496 = G__33497;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq33494){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33494));
});
...
var args__29609__auto__ = [];
var len__29602__auto___33503 = arguments.length;
var i__29603__auto___33504 = (0);
while(true){
if((i__29603__auto___33504 < len__29602__auto___33503)){
args__29609__auto__.push((arguments[i__29603__auto___33504]));

var G__33505 = (i__29603__auto___33504 + (1));
i__29603__auto___33504 = G__33505;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__33498_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__33499_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__33499_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq33500){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__33501,G__33502,seq33500__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1503577466422
