...
var o32332 = temp__4655__auto__;
var temp__4655__auto____$1 = (o32332["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o32333 = temp__4655__auto____$1;
return (o32333["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__31476__auto__ = f;
return (o__31476__auto__["toString"]).call(o__31476__auto__);
} else {
return "";
}
}catch (e32334){var _ = e32334;
return "";
}});
...
try{var o__31476__auto___32336 = t;
(o__31476__auto___32336["cljs$lang$ctorPrWriter"]).call(o__31476__auto___32336,t,writer);
}catch (e32335){var __32337 = e32335;
}
...
var char_code = (function (){var o__31476__auto__ = (new String(char$));
return (o__31476__auto__["charCodeAt"]).call(o__31476__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__31476__auto__ = String;
return (o__31476__auto__["fromCharCode"]).call(o__31476__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__32338 = num_code;
switch (G__32338) {
case (1):
return (185);
...
var o__31476__auto__ = String;
return (o__31476__auto__["fromCharCode"]).call(o__31476__auto__,superscript_code);
});
/**
...
}catch (e32340){var _e__31483__auto__ = e32340;
return false;
}})())){
...
var vec__32341 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__32341,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o32344 = temp__4655__auto__;
var temp__4655__auto____$1 = (o32344["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o32345 = temp__4655__auto____$1;
return (o32345["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29602__auto___32352 = arguments.length;
var i__29603__auto___32353 = (0);
while(true){
if((i__29603__auto___32353 < len__29602__auto___32352)){
args__29609__auto__.push((arguments[i__29603__auto___32353]));

var G__32354 = (i__29603__auto___32353 + (1));
i__29603__auto___32353 = G__32354;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__32348){
var vec__32349 = p__32348;
var ns_detector = cljs.core.nth.call(null,vec__32349,(0),null);
...
var G__32355 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__32356 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__32355;
remaining_tokens = G__32356;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq32346){
var G__32347 = cljs.core.first.call(null,seq32346);
var seq32346__$1 = cljs.core.next.call(null,seq32346);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__32347,seq32346__$1);
});
...
var vec__32360 = cljs.core.split_with.call(null,(function (p1__32359_SHARP_){
return cljs.core.not_EQ_.call(null,p1__32359_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__32360,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__32360,(1),null);
...
var vec__32363 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__32363,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__32363,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__32366 = cljs.core.rest.call(null,remaining_tokens);
var G__32367 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__32366;
name_tokens = G__32367;
continue;
} else {
...
var vec__32370 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__32370,(0),null);
var arity = cljs.core.nth.call(null,vec__32370,(1),null);
var vec__32373 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__32373,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__32373,(1),null);
var vec__32376 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__32376,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__32376,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__32376,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__32376,(3),null);
...
var vec__32382 = result;
var munged_ns = cljs.core.nth.call(null,vec__32382,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__32382,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__32382,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__32382,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__32382,(4),null);
var arity = cljs.core.nth.call(null,vec__32382,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__32386 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__32386,(0),null);
var args = cljs.core.nth.call(null,vec__32386,(1),null);
var vec__32389 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__32389,(0),null);
var name = cljs.core.nth.call(null,vec__32389,(1),null);
...
var G__32392 = (arity + (1));
var G__32393 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__32394){
var vec__32395 = p__32394;
var arity = cljs.core.nth.call(null,vec__32395,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__32395,(1),null);
...
return cljs.core.get.call(null,arities,p1__32398_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__32399_SHARP_);
...
var args__29609__auto__ = [];
var len__29602__auto___32406 = arguments.length;
var i__29603__auto___32407 = (0);
while(true){
if((i__29603__auto___32407 < len__29602__auto___32406)){
args__29609__auto__.push((arguments[i__29603__auto___32407]));

var G__32408 = (i__29603__auto___32407 + (1));
i__29603__auto___32407 = G__32408;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__32402){
var vec__32403 = p__32402;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__32403,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq32400){
var G__32401 = cljs.core.first.call(null,seq32400);
var seq32400__$1 = cljs.core.next.call(null,seq32400);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__32401,seq32400__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__32411__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__32411__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__32411__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__32411__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__32412 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__32412,(0),null);
var fn_name = cljs.core.nth.call(null,vec__32412,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__32412,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__32412,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__32412,(4),null);
var arity = cljs.core.nth.call(null,vec__32412,(5),null);
...
var o__31476__auto__ = f;
return (o__31476__auto__["getBasis"]).call(o__31476__auto__);
});
/**
...
}catch (e32416){var _e__31483__auto__ = e32416;
...
var G__32417 = (obj[cljs.core.first.call(null,path)]);
var G__32418 = cljs.core.rest.call(null,path);
obj = G__32417;
path = G__32418;
continue;
} else {
...
return (function (accum,p__32419){
var vec__32420 = p__32419;
var bit = cljs.core.nth.call(null,vec__32420,(0),null);
var protocol = cljs.core.nth.call(null,vec__32420,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__32423){
var vec__32424 = p__32423;
var ns = cljs.core.nth.call(null,vec__32424,(0),null);
var name = cljs.core.nth.call(null,vec__32424,(1),null);
var selector = cljs.core.nth.call(null,vec__32424,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__32429,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__32429,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__32429,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__32427_SHARP_){
return (obj[cljs.core.first.call(null,p1__32427_SHARP_)]);
});})(name,sorted_matches,vec__32429,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1503758418276
