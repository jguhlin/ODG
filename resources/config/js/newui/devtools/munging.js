...
var o31454 = temp__4655__auto__;
var temp__4655__auto____$1 = (o31454["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o31455 = temp__4655__auto____$1;
return (o31455["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__30586__auto__ = f;
return (o__30586__auto__["toString"]).call(o__30586__auto__);
} else {
return "";
}
}catch (e31456){var _ = e31456;
return "";
}});
...
try{var o__30586__auto___31458 = t;
(o__30586__auto___31458["cljs$lang$ctorPrWriter"]).call(o__30586__auto___31458,t,writer);
}catch (e31457){var __31459 = e31457;
}
...
var char_code = (function (){var o__30586__auto__ = (new String(char$));
return (o__30586__auto__["charCodeAt"]).call(o__30586__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30586__auto__ = String;
return (o__30586__auto__["fromCharCode"]).call(o__30586__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__31460 = num_code;
switch (G__31460) {
case (1):
return (185);
...
var o__30586__auto__ = String;
return (o__30586__auto__["fromCharCode"]).call(o__30586__auto__,superscript_code);
});
/**
...
}catch (e31462){var _e__30593__auto__ = e31462;
return false;
}})())){
...
var vec__31463 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__31463,(0),null);
...
var or__28433__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o31466 = temp__4655__auto__;
var temp__4655__auto____$1 = (o31466["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o31467 = temp__4655__auto____$1;
return (o31467["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29602__auto___31474 = arguments.length;
var i__29603__auto___31475 = (0);
while(true){
if((i__29603__auto___31475 < len__29602__auto___31474)){
args__29609__auto__.push((arguments[i__29603__auto___31475]));

var G__31476 = (i__29603__auto___31475 + (1));
i__29603__auto___31475 = G__31476;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29610__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__31470){
var vec__31471 = p__31470;
var ns_detector = cljs.core.nth.call(null,vec__31471,(0),null);
var effective_detector = (function (){var or__28433__auto__ = ns_detector;
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
...
var G__31477 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__31478 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__31477;
remaining_tokens = G__31478;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq31468){
var G__31469 = cljs.core.first.call(null,seq31468);
var seq31468__$1 = cljs.core.next.call(null,seq31468);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__31469,seq31468__$1);
});
...
var vec__31482 = cljs.core.split_with.call(null,(function (p1__31481_SHARP_){
return cljs.core.not_EQ_.call(null,p1__31481_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__31482,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__31482,(1),null);
...
var vec__31485 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__31485,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__31485,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__31488 = cljs.core.rest.call(null,remaining_tokens);
var G__31489 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__31488;
name_tokens = G__31489;
continue;
} else {
...
var vec__31492 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__31492,(0),null);
var arity = cljs.core.nth.call(null,vec__31492,(1),null);
var vec__31495 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__31495,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__31495,(1),null);
var vec__31498 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__31498,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__31498,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__31498,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__31498,(3),null);
...
var vec__31504 = result;
var munged_ns = cljs.core.nth.call(null,vec__31504,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__31504,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__31504,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__31504,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__31504,(4),null);
var arity = cljs.core.nth.call(null,vec__31504,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__31508 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__31508,(0),null);
var args = cljs.core.nth.call(null,vec__31508,(1),null);
var vec__31511 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__31511,(0),null);
var name = cljs.core.nth.call(null,vec__31511,(1),null);
...
var G__31514 = (arity + (1));
var G__31515 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__31516){
var vec__31517 = p__31516;
var arity = cljs.core.nth.call(null,vec__31517,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__31517,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__28433__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__31520_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__31521_SHARP_);
...
var args__29609__auto__ = [];
var len__29602__auto___31528 = arguments.length;
var i__29603__auto___31529 = (0);
while(true){
if((i__29603__auto___31529 < len__29602__auto___31528)){
args__29609__auto__.push((arguments[i__29603__auto___31529]));

var G__31530 = (i__29603__auto___31529 + (1));
i__29603__auto___31529 = G__31530;
continue;
} else {
}
break;
...
var argseq__29610__auto__ = ((((1) < args__29609__auto__.length))?(new cljs.core.IndexedSeq(args__29609__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29610__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__31524){
var vec__31525 = p__31524;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__31525,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq31522){
var G__31523 = cljs.core.first.call(null,seq31522);
var seq31522__$1 = cljs.core.next.call(null,seq31522);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__31523,seq31522__$1);
});
...
var G__31531 = arg;
var G__31531__$1 = (((G__31531 instanceof cljs.core.Keyword))?G__31531.fqn:null);
switch (G__31531__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__28433__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__28421__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__28433__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__31533__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__31533__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__31533__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__31533__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__31534 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__31534,(0),null);
var fn_name = cljs.core.nth.call(null,vec__31534,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__31534,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__31534,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__31534,(4),null);
var arity = cljs.core.nth.call(null,vec__31534,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__28421__auto__ = protocol_ns;
if(cljs.core.truth_(and__28421__auto__)){
return cljs.core.not.call(null,(function (){var and__28421__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__28433__auto__ = protocol_part;
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
return fn_part;
...
var o__30586__auto__ = f;
return (o__30586__auto__["getBasis"]).call(o__30586__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__28421__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__28421__auto__)){
...
}catch (e31538){var _e__30593__auto__ = e31538;
...
var G__31539 = (obj[cljs.core.first.call(null,path)]);
var G__31540 = cljs.core.rest.call(null,path);
obj = G__31539;
path = G__31540;
continue;
} else {
...
var partition_bits = (function (){var or__28433__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
return (0);
...
return (function (accum,p__31541){
var vec__31542 = p__31541;
var bit = cljs.core.nth.call(null,vec__31542,(0),null);
var protocol = cljs.core.nth.call(null,vec__31542,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__31545){
var vec__31546 = p__31545;
var ns = cljs.core.nth.call(null,vec__31546,(0),null);
var name = cljs.core.nth.call(null,vec__31546,(1),null);
var selector = cljs.core.nth.call(null,vec__31546,(2),null);
...
return (function (p__31550){
var vec__31551 = p__31550;
var munged_name = cljs.core.nth.call(null,vec__31551,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__31551,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__31551,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__31549_SHARP_){
return (obj[cljs.core.first.call(null,p1__31549_SHARP_)]);
});})(name,sorted_matches,vec__31551,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1503582237563
