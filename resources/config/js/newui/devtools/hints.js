...
var reader = (function (){var or__28433__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__28433__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
return (128);
...
var line = cljs.core.get.call(null,map__36631__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__36631__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e36630){var _e = e36630;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___36633 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___36633)){
var seen_errors_36634 = temp__4655__auto___36633;
if(cljs.core.truth_(seen_errors_36634.has(self))){
} else {
seen_errors_36634.add(self);

var temp__4657__auto___36635 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___36635)){
var sense_36636 = temp__4657__auto___36635;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_36636)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1503758425298
