...
var line = cljs.core.get.call(null,map__33024__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__33024__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e33023){var _e = e33023;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___33026 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___33026)){
var seen_errors_33027 = temp__4655__auto___33026;
if(cljs.core.truth_(seen_errors_33027.has(self))){
} else {
seen_errors_33027.add(self);

var temp__4657__auto___33028 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___33028)){
var sense_33029 = temp__4657__auto___33028;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_33029)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1503582239661
