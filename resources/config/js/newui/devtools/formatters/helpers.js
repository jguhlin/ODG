...
var G__31556 = devtools.prefs.pref.call(null,v);
v = G__31556;
continue;
} else {
return v;
...
var and__28421__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__28421__auto__){
var and__28421__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__28433__auto__ = (function (){try{if(!((value == null))){
...
}catch (e31559){var _e__30593__auto__ = e31559;
return false;
}})();
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
var or__28433__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e31563){var _e__30593__auto__ = e31563;
return false;
}})();
...
}catch (e31565){var _e__30593__auto__ = e31565;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__28421__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__28421__auto__)){
var and__28421__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__28421__auto____$1){
...
var and__28421__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__28421__auto__)){
...
var or__28433__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
...
var and__28421__auto__ = (function (){var or__28433__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
...
var vec__31567 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__31567,(0),null);
var name = cljs.core.nth.call(null,vec__31567,(1),null);
...
var and__28421__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__28421__auto__)){
...
var or__28433__auto__ = typeof value === 'string';
if(or__28433__auto__){
return or__28433__auto__;
} else {
var or__28433__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__31570_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__31570_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1503582237679
