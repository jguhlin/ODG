...
return clojure.string.join.call(null,(function (){var iter__29241__auto__ = (function markdown$lists$close_lists_$_iter__32406(s__32407){
return (new cljs.core.LazySeq(null,(function (){
var s__32407__$1 = s__32407;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__32407__$1);
if(temp__4657__auto__){
var s__32407__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__32407__$2)){
var c__29239__auto__ = cljs.core.chunk_first.call(null,s__32407__$2);
var size__29240__auto__ = cljs.core.count.call(null,c__29239__auto__);
var b__32409 = cljs.core.chunk_buffer.call(null,size__29240__auto__);
if((function (){var i__32408 = (0);
while(true){
if((i__32408 < size__29240__auto__)){
var vec__32410 = cljs.core._nth.call(null,c__29239__auto__,i__32408);
var list_type = cljs.core.nth.call(null,vec__32410,(0),null);
cljs.core.chunk_append.call(null,b__32409,["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,list_type)),">"].join(''));

var G__32416 = (i__32408 + (1));
i__32408 = G__32416;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__32409),markdown$lists$close_lists_$_iter__32406.call(null,cljs.core.chunk_rest.call(null,s__32407__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__32409),null);
}
} else {
var vec__32413 = cljs.core.first.call(null,s__32407__$2);
var list_type = cljs.core.nth.call(null,vec__32413,(0),null);
return cljs.core.cons.call(null,["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,list_type)),">"].join(''),markdown$lists$close_lists_$_iter__32406.call(null,cljs.core.rest.call(null,s__32407__$2)));
}
} else {
return null;
}
...
return iter__29241__auto__.call(null,lists);
})());
});
...
var lists_to_close = cljs.core.take_while.call(null,(function (p1__32417_SHARP_){
return (cljs.core.second.call(null,p1__32417_SHARP_) > num_indents);
...
var vec__32418 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__32418,(0),null);
var indents = cljs.core.nth.call(null,vec__32418,(1),null);
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ul","ul",-1349521403),list_type,num_indents,indents,(function (){var or__28433__auto__ = markdown.common.make_heading.call(null,content,false);
...
var vec__32421 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__32421,(0),null);
var indents = cljs.core.nth.call(null,vec__32421,(1),null);
var num_indents = cljs.core.count.call(null,cljs.core.take_while.call(null,cljs.core.partial.call(null,cljs.core._EQ_," "),text));
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ol","ol",932524051),list_type,num_indents,indents,(function (){var or__28433__auto__ = markdown.common.make_heading.call(null,content,false);
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
return content;
...
markdown.lists.li = (function markdown$lists$li(text,p__32424){
...
var code = cljs.core.get.call(null,map__32425__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__32425__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__32425__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.call(null,map__32425__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__32425__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
if(cljs.core.truth_((function (){var and__28421__auto__ = last_line_empty_QMARK_;
...
if(cljs.core.truth_((function (){var and__28421__auto__ = lists;
if(cljs.core.truth_(and__28421__auto__)){
var or__28433__auto__ = last_line_empty_QMARK_;
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
return eof;
...
var and__28421__auto____$1 = lists;
...
if(cljs.core.truth_((function (){var and__28421__auto__ = (function (){var or__28433__auto__ = eof;
if(cljs.core.truth_(or__28433__auto__)){
return or__28433__auto__;
} else {
...
//# sourceMappingURL=lists.js.map?rel=1503499632213
