...
var vec__33457_33460 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_33461 = cljs.core.nth.call(null,vec__33457_33460,(0),null);
var only_after_33462 = cljs.core.nth.call(null,vec__33457_33460,(1),null);
var db_changed_QMARK__33463 = (!((only_before_33461 == null))) || (!((only_after_33462 == null)));
if(db_changed_QMARK__33463){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_33461);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_33462);
...
var map__33464 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__33464__$1 = ((((!((map__33464 == null)))?((((map__33464.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33464.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__33464):map__33464);
var db = cljs.core.get.call(null,map__33464__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__33464__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__33466 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__33466__$1;
var event = cljs.core.get.call(null,map__33466__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__29602__auto___33469 = arguments.length;
var i__29603__auto___33470 = (0);
while(true){
if((i__29603__auto___33470 < len__29602__auto___33469)){
args__29609__auto__.push((arguments[i__29603__auto___33470]));

var G__33471 = (i__29603__auto___33470 + (1));
i__29603__auto___33470 = G__33471;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__29610__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq33468){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33468));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__28433__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__29609__auto__ = [];
var len__29602__auto___33477 = arguments.length;
var i__29603__auto___33478 = (0);
while(true){
if((i__29603__auto___33478 < len__29602__auto___33477)){
args__29609__auto__.push((arguments[i__29603__auto___33478]));

var G__33479 = (i__29603__auto___33478 + (1));
i__29603__auto___33478 = G__33479;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__29610__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__33472_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__33473_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__33473_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__28421__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq33474){
var G__33475 = cljs.core.first.call(null,seq33474);
var seq33474__$1 = cljs.core.next.call(null,seq33474);
var G__33476 = cljs.core.first.call(null,seq33474__$1);
var seq33474__$2 = cljs.core.next.call(null,seq33474__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__33475,G__33476,seq33474__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1503499633644
