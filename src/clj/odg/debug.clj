...
(def proteome (odg.proteome/import-fasta "Vespula vulgaris" "1" "data/vvul/augustus.hints.aa" annotation))
; (def proteins (get-from-file "data/vvul/augustus.hints.aa"))
